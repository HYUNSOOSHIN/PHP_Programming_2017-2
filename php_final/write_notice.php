...
if(isset($_POST['submit'])){
    ...
    if($name==""){
        ...
        $sql = "INSERT INTO notice VALUES (NULL,'$name','$user','','','$comment')" ;
        ...
        /*if($image_size == FALSE) {
            ...
            $sql = "INSERT INTO notice VALUES (NULL,'$name','$user','$image_data','$image_name','$comment')" ;
	...
	<div id="bodycontainer">
		...
		<div id="bodycontainerpan">
			<div id="pmaim">
				<div class="container">  
					<div class="col-xs-8"> 
					<h3 align="center">공지사항 글쓰기</h3><br><br>
					<form class="form-inline" action="write_notice.php" method="POST" enctype="multipart/form-data"> 
