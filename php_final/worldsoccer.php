...
<div id="frame"> 
	...
	<div id="bodycontainer">
		<div id="bodycontainerleft">
			<div id="lmaim">
				<form method="post" action="worldsoccer.php">
					<?php 
					if(isset($_SESSION['adminlogin'])){
		...
		<div id="bodycontainerpan">
			<div id="pmaim">
				<div class="container">         
					<div class="col-xs-7">
						<h4 align="center">해외축구에 대해 잘 아는 사람을 위한</h4>
						<h3 align="center">해.축.잘.알 게시판</h3><br><br> 
					<form class="form-inline" method="post" action="worldsoccer.php"> 
					...
					<table class="table table-striped" >
							...
							if(isset($_POST['searchbtn'])){
								...
								if($select=="제목"){
									$sql="SELECT * FROM world WHERE name  like '%$search%' order by id desc";
								} else if($select=="작성자"){
									$sql="SELECT * FROM world WHERE user  like '%$search%' order by id desc";
								}
					...
					?>
						<a class="btn btn-success pull-right" href="write_world.php">글쓰기</a>
					<?php
					} 
					?> 
					</div>
