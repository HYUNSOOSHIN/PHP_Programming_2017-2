...
if(isset($_POST['submit'])){
    ...
    if($name==""){
        ...
        $sql = "INSERT INTO free VALUES (NULL,'$selected', '$name', '$user', '', '', '$comment')" ;
        ...
        /*if($image_size == FALSE) {
            ...
            $sql = "INSERT INTO free VALUES (NULL,'$selected','$name','$user','$image_data','$image_name','$comment')" ;
...
<div id="frame"> 
	...
	<div id="bodycontainer">
		<div id="bodycontainerleft">
			<div id="lmaim">
				<form method="post" action="write_free.php">
				<?php 
		...
		<div id="bodycontainerpan">
			<div id="pmaim">
				<div class="container"> 
					<div class="col-xs-8"> 
					<h3 align="center">자유게시판 글쓰기</h3><br><br>
					<form class="form-inline" action="write_free.php" method="POST" enctype="multipart/form-data">
					<div class="form-group">
						<table class="table">
                            <tbody>
                              <tr>
                                <td><label for="id">분류:</label></td>
