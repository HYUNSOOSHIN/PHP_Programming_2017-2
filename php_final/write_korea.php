...
if(isset($_POST['submit'])){
    ...
    if($name==""){
        ...
        $sql = "INSERT INTO korea VALUES (NULL,'$name','$user','','','$comment')" ;
        ...
        /*if($image_size == FALSE) {
            ...
            $sql = "INSERT INTO korea VALUES (NULL,'$name','$user','$image_data','$image_name','$comment')" ;
...
<div id="frame"> 
	...
	<div id="bodycontainer">
		<div id="bodycontainerleft">
			<div id="lmaim">
				<form method="post" action="write_korea.php">
				<?php 
		...
		<div id="bodycontainerpan">
			<div id="pmaim">
				<div class="container">
					<div class="col-xs-8">    
					<h3 align="center">한축잘알 글쓰기</h3><br><br>
					<form class="form-inline" action="write_korea.php" method="POST" enctype="multipart/form-data">
